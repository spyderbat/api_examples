...
class UserApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.user_auth_endpoint = _Endpoint(
            settings={
                'response_type': (User,),
                'auth': [
                    'apiToken'
                ],
                'endpoint_path': '/api/v1/app/user/auth',
                'operation_id': 'user_auth',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.user_signup_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'apiToken'
                ],
                'endpoint_path': '/api/v1/app/signup',
    ...
    def user_auth(
        ...
        **kwargs
        ...
        """Authenticate a user, returns token required for authentication  # noqa: E501
         ...
         Users may be authenticate by providing their email address and password as a JSON object, in response an authentication token will be returned in the header 'Authorization-Token'. The returned token must be used in a request header with the name 'Authorization' when making other authenticated API calls, for example 'Authorization: Bearer TOKEN'.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.user_auth(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            user_auth_input (UserAuthInput): [optional]
        ...
        return self.user_auth_endpoint.call_with_http_info(**kwargs)
    ...
    def user_signup(
        ...
        **kwargs
        ...
        >>> thread = api.user_signup(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.user_signup_endpoint.call_with_http_info(**kwargs)
