...
class MetricsDataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.metrics_data_query_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'apiToken'
                ],
                'endpoint_path': '/api/v1/metrics/query/',
                'operation_id': 'metrics_data_query',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'metrics_data_query_input',
                ],
                'required': [],
                'nullable': [
                ],
    ...
    def metrics_data_query(
        ...
        **kwargs
        ...
        return self.metrics_data_query_endpoint.call_with_http_info(**kwargs)
