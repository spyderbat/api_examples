...
*InternalAPIApi* | [**log_data**](docs/InternalAPIApi.md#log_data) | **POST** /api/v1/_/log | Logs data
...
*UserApi* | [**user_auth**](docs/UserApi.md#user_auth) | **POST** /api/v1/app/user/auth | Authenticate a user, returns token required for authentication
...
*UserApi* | [**user_signup**](docs/UserApi.md#user_signup) | **GET** /api/v1/app/signup | Sign up a new user
