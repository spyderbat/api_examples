...
class OrgApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.org_load_notification_policy_endpoint = _Endpoint(
            settings={
                'response_type': (NotificationPolicy,),
                'auth': [
                    'apiToken'
                ],
    ...
    def org_update_notification_policy(
        ...
        **kwargs
        ...
        >>> thread = api.org_update_notification_policy(org_uid, notification_policy, async_req=True)
        >>> result = thread.get()

        Args:
            org_uid (str):
            notification_policy (NotificationPolicy): The notification policy
