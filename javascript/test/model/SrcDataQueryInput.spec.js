...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.SrcDataQueryInput();
  });
  ...
  describe('SrcDataQueryInput', function() {
    it('should create an instance of SrcDataQueryInput', function() {
      // uncomment below and update the code to test SrcDataQueryInput
      //var instance = new SpyderbatApi.SrcDataQueryInput();
      //expect(instance).to.be.a(SpyderbatApi.SrcDataQueryInput);
    });
