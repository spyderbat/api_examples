...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.InvestigationCreateInput();
  });
  ...
  describe('InvestigationCreateInput', function() {
    it('should create an instance of InvestigationCreateInput', function() {
      // uncomment below and update the code to test InvestigationCreateInput
      //var instance = new SpyderbatApi.InvestigationCreateInput();
      //expect(instance).to.be.a(SpyderbatApi.InvestigationCreateInput);
    });
