...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sbapi.UiDataSetUserSourceDataInput();
  });
  ...
  describe('UiDataSetUserSourceDataInput', function() {
    it('should create an instance of UiDataSetUserSourceDataInput', function() {
      ...
      //var instance = new Sbapi.UiDataSetUserSourceDataInput();
      //expect(instance).to.be.a(Sbapi.UiDataSetUserSourceDataInput);
    });
