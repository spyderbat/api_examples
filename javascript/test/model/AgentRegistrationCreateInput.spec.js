...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.AgentRegistrationCreateInput();
  });
  ...
  describe('AgentRegistrationCreateInput', function() {
    it('should create an instance of AgentRegistrationCreateInput', function() {
      ...
      //var instance = new SpyderbatApi.AgentRegistrationCreateInput();
      //expect(instance).to.be.a(SpyderbatApi.AgentRegistrationCreateInput);
    });
