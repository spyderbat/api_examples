...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.UiDataSetOrgDataInput();
  });
  ...
  describe('UiDataSetOrgDataInput', function() {
    it('should create an instance of UiDataSetOrgDataInput', function() {
      // uncomment below and update the code to test UiDataSetOrgDataInput
      //var instance = new SpyderbatApi.UiDataSetOrgDataInput();
      //expect(instance).to.be.a(SpyderbatApi.UiDataSetOrgDataInput);
    });
