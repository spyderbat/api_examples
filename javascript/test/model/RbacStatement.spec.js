...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.RbacStatement();
  });
  ...
  describe('RbacStatement', function() {
    it('should create an instance of RbacStatement', function() {
      // uncomment below and update the code to test RbacStatement
      //var instance = new SpyderbatApi.RbacStatement();
      //expect(instance).to.be.a(SpyderbatApi.RbacStatement);
    });
