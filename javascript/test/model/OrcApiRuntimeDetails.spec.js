...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.OrcApiRuntimeDetails();
  });
  ...
  describe('OrcApiRuntimeDetails', function() {
    it('should create an instance of OrcApiRuntimeDetails', function() {
      ...
      //var instance = new SpyderbatApi.OrcApiRuntimeDetails();
      //expect(instance).to.be.a(SpyderbatApi.OrcApiRuntimeDetails);
    });
