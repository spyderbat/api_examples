...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.UiDataSetSourceDataInput();
  });
  ...
  describe('UiDataSetSourceDataInput', function() {
    it('should create an instance of UiDataSetSourceDataInput', function() {
      // uncomment below and update the code to test UiDataSetSourceDataInput
      //var instance = new SpyderbatApi.UiDataSetSourceDataInput();
      //expect(instance).to.be.a(SpyderbatApi.UiDataSetSourceDataInput);
    });
