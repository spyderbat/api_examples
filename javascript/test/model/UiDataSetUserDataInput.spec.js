...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.UiDataSetUserDataInput();
  });
  ...
  describe('UiDataSetUserDataInput', function() {
    it('should create an instance of UiDataSetUserDataInput', function() {
      ...
      //var instance = new SpyderbatApi.UiDataSetUserDataInput();
      //expect(instance).to.be.a(SpyderbatApi.UiDataSetUserDataInput);
    });
