...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.InvestigationUpdateInput();
  });
  ...
  describe('InvestigationUpdateInput', function() {
    it('should create an instance of InvestigationUpdateInput', function() {
      // uncomment below and update the code to test InvestigationUpdateInput
      //var instance = new SpyderbatApi.InvestigationUpdateInput();
      //expect(instance).to.be.a(SpyderbatApi.InvestigationUpdateInput);
    });
