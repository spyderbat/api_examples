...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.DaoInvestigation();
  });
  ...
  describe('DaoInvestigation', function() {
    it('should create an instance of DaoInvestigation', function() {
      // uncomment below and update the code to test DaoInvestigation
      //var instance = new SpyderbatApi.DaoInvestigation();
      //expect(instance).to.be.a(SpyderbatApi.DaoInvestigation);
    });
