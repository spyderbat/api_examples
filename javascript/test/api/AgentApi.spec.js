...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpyderbatApi.AgentApi();
  });
  ...
  describe('AgentApi', function() {
    ...
    describe('agentLoad', function() {
      it('should call agentLoad successfully', function(done) {
        //uncomment below and update the code to test agentLoad
        //instance.agentLoad(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
