...
func (r ApiSrcDataQueryRequest) Execute() (*http.Response, error) {
...
func (a *SourceDataApiService) SrcDataQueryExecute(r ApiSrcDataQueryRequest) (*http.Response, error) {
	var (
...
func (r ApiSrcDataQueryV2Request) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *SourceDataApiService) SrcDataQueryV2Execute(r ApiSrcDataQueryV2Request) (*http.Response, error) {
	var (
	...
	if r.dt == nil {
		return nil, reportError("dt is required and must be specified")
	}
	if strlen(*r.dt) > 24 {
		return nil, reportError("dt must have less than 24 elements")
	}
