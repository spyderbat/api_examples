...
func (r ApiOrgLoadNotificationPolicyRequest) Execute() (*NotificationPolicy, *http.Response, error) {
...
func (a *OrgApiService) OrgLoadNotificationPolicyExecute(r ApiOrgLoadNotificationPolicyRequest) (*NotificationPolicy, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NotificationPolicy
	)
	...
	// to determine the Accept header
	localVarHTTPHeaderAccepts := []string{"application/hjson", "application/json"}
...
func (r ApiOrgUpdateNotificationPolicyRequest) NotificationPolicy(notificationPolicy NotificationPolicy) ApiOrgUpdateNotificationPolicyRequest {
	r.notificationPolicy = &notificationPolicy
	return r
}
...
func (a *OrgApiService) OrgUpdateNotificationPolicyExecute(r ApiOrgUpdateNotificationPolicyRequest) (*http.Response, error) {
	...
	if r.notificationPolicy == nil {
		return nil, reportError("notificationPolicy is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.notificationPolicy
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
